...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
    <div class="content-wrap mt-5 mb-5" style="max-width:700px; box-shadow: 1px 2px 4px rgba(0, 0, 0, .5);  background-color:white;">
		...
		<table style="width:100%;">
            <tr>
				<td class="auto-style2 font_style_two" style="padding-top:220px;">Profile Picture</td>
				<td>
                    <p class="font_style_two" style="font-size:12px">Maximum Profile Picture size is 500x300 pixels.</p>
                    <img id="imgpreview" height="170" width="170" src="upload/user/<%= (String)Session["Image"] %>" style="border-width:0px;  margin-bottom:10px;" class="border"/>
