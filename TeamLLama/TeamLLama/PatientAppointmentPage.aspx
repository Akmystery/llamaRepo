...
<asp:Content ID="c_content" ContentPlaceHolderID="ContentBody" runat="server">
      ...
      <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div>
            ...
            <cc1:ModalPopupExtender ID="confirmPopup" runat="server" PopupControlID="CfmPanel" TargetControlID="btnDelete" CancelControlID="btnNo" BackgroundCssClass="modalBackground"></cc1:ModalPopupExtender>
            <asp:Panel ID="CfmPanel" runat="server" CssClass="modalPopup1" align="center" style = "display:none">
                <asp:Label ID="lblMsg" runat="server" Text="Are You Sure You Want To Delete?" Visible="true"></asp:Label><br /><br /><br />
                <br />
