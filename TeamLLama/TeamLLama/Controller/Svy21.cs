// https://github.com/cgcai/SVY21/blob/master/csharp/svy21/Svy21.cs
using System;
...
public class Svy21
{
    ...
    public static Tuple<double, double> ComputeLatitudeLongitude(double easting, double northing)
    {
        ...
        return Tuple.Create(lat / RadRatio, lon / RadRatio);
    }

    public static Tuple<double, double> ComputeSvy21(double latitude, double longitude)
    {
        ...
        return Tuple.Create(northing, easting);
    }
}
