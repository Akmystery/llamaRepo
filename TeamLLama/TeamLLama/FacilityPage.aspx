    ...
    <div class="container">
        ...
        <div class="tabbed">
            ...
            <div id="tab-information" class="tab">
                <div><asp:Image ID="imgFacility" runat="server"/></div>
                <div><b>General Information:</b> <asp:Literal ID="lblInformation" runat="server" /><br />
                    <b>Contact:</b> <asp:Literal ID="lblContact" runat="server"/><br />
                    <b>Address:</b> <asp:Literal ID="lblAddress" runat="server"/><br />
                    <b>Operating Hours:</b> <asp:Literal ID="lblOperatingHours" runat="server"/><br />
                    <b>Rating: </b><asp:Literal ID="lblRatingNumber" runat="server"/>
                </div>
                <br />
                <div><asp:Button ID="btnBookAppointment" runat="server" Text="Book Appointment" OnClick="btnBookAppointment_Click"/></div>
            </div>

            <div id="tab-map" class="tab" style="display:none;">
                <iframe
            ...
            <div id="tab-ratings" class="tab" style="display:none;">
